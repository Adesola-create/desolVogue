    ...
    <div class="row">
      ...
      <div class="col-lg-6 new_arrivals"> 
        ...
        <div class="section-title text-start">
          ...
          dj ghhjreslgtirj.njhiebnj bnjfsuitnhljfidthuhyuftuhlygr.uhyMNhk.thueuioueoiruieftgjykhulji;k;jhhggvcb fuhhhjdnvxcnhyuxdyfdbjcxhjhjhjculbn vlyucxvjhh.uujmNhjjmnkhkhnmkjvmv,j jkkb lkjjk. </span> </div>
        <!-- Section Title End --> 
          ...
          <li>
            <div class="testimonial swiper-slide swiper-slide-active">
              ...
              <div class="testimonial-author"> <i class="flaticon-quote"></i>
                ...
                <p>book. </p>
                <span><span>Elizabeth - </span>Customer</span> </div>
            </div>
          </li>
          <li>
            <div class="testimonial swiper-slide swiper-slide-active">
              ...
              <div class="testimonial-author"> <i class="flaticon-quote"></i>
                ...
                <span><span>tolu - </span>Customer</span> </div>
            </div>
          </li>
          <li>
            <div class="testimonial swiper-slide swiper-slide-active">
              ...
              <div class="testimonial-author"> <i class="flaticon-quote"></i>
                ...
                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. </p>
                <span><span>funke- </span>Customer</span> </div>
            </div>
          </li>
          <li>
            <div class="testimonial swiper-slide swiper-slide-active">
              ...
              <div class="testimonial-author"> <i class="flaticon-quote"></i>
                ...
                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. </p>
                <span><span>badah - </span>Customer</span> </div>
            </div>
          </li>
        </ul>
